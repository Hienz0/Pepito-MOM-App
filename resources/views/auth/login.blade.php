...
<!-- Navbar -->
<nav style="background-color: #F9F9F9;" class="fixed w-full shadow-md h-20 py-4">
...
<!-- Main content -->
    ...
    <div class="flex items-center justify-center min-h-screen">
        <div class="flex bg-white shadow-md rounded px-8 py-6 w-full max-w-4xl">
            <!-- Image Section -->
            <div class="hidden md:block w-2/3 mr-4">
                <img src="{{ asset('images/login-image.png') }}" alt="Login Image" class="h-full w-full object-cover rounded-l">
            </div>
            <!-- Form Section -->
